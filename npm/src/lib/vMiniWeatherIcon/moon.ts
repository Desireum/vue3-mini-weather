...
/* 大月亮-全 */
export const moonFill = (moonColor?:number[], starColor?:number[]) => {
  return [...starTemplate(starColor), moonTemplate('fill', moonColor)]
}
/* 大月亮-线 */
export const moonLine = (moonColor?:number[], starColor?:number[]) => {
  return [...starTemplate(starColor), moonTemplate('line', moonColor)]
}
/* 小月亮-全 */
export const smallMoonFill = (color?:number[]) => {
  return moonSmallTemplate('fill', color)
}
/* 小月亮-线 */
export const smallMoonLine = (color?:number[]) => {
  return moonSmallTemplate('line', color)
}
/* 大月亮-模板 */
const moonTemplate = (type:StyleType, color?:number[]) => {
...
/* 月亮描边宽度 */
const getMoonStrokeWidth = (type:StyleType, size:string) => {
  return type === 'line' ? (size === 'small' ? 9 : 20) : (size === 'small' ? 4 : 6)
}
/* 大月亮-填充方式-单色描边/渐变填充/单色填充 */
const moonFillTemplate = (type:StyleType, size:string, color?:number[]) => {
...
/* 星星-模板 */
const starTemplate = (color?:number[]) => {
  return [
    {
      ddd: 0,
      ind: 1,
...
/* 星星-填充方式-渐变填充/单色填充 */
const starFillTemplate = (index:number, color?:number[]) => {
...
/* 星星-渐变填充模板 */
const starGradientFillTemplate = (index:number) => {
...
/* 小月亮-模板 */
const moonSmallTemplate = (type:StyleType, color?:number[]) => {
  const moonFill:any = moonFillTemplate(type, 'small', color)
  const template:any = {
    ddd: 0,
    ind: 3,
    ty: 4,
