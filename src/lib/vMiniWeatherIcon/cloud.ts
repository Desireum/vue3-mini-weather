...
/* 单片的云-全 */
export const cloudFill = (color?: number[]) => {
  return cloudTemplate('fill', color)
}
/* 单片的云-线 */
export const cloudLine = (color?: number[]) => {
  return cloudTemplate('line', color)
}
/* 双片的云-全 */
export const cloudyFill = (lightColor?: number[], darkColor?: number[]) => {
  return cloudyTemplate('fill', lightColor, darkColor)
}
/* 双片的云-线 */
export const cloudyLine = (lightColor?: number[], darkColor?: number[]) => {
  return cloudyTemplate('line', lightColor, darkColor)
}
/* 斜的云-全 */
export const obliqueCloudFill = (color?: number[]) => {
  return obliqueCloudTemplate('fill', color)
}
/* 斜的云-线 */
export const obliqueCloudLine = (color?: number[]) => {
  return obliqueCloudTemplate('line', color)
}
/* 单片的云-模板 */
const cloudTemplate = (type: StyleType, color?: number[]) => {
...
const cloudFillTemplate = (type: StyleType, color?: number[]) => {
...
/* 单色描边 */
const strokeTemplate = (color: number[], width: number) => {
  return {
    ty: 'st',
    c: {
      a: 0,
...
/* 双片的云-模板 */
const cloudyTemplate = (type: StyleType, lightColor?: number[], darkColor?: number[]) => {
  const template: any[] = [
    {
      ddd: 0,
      ind: 1,
...
const cloudyLightCloudFillTemplate = (type: StyleType, color?: number[]) => {
...
const cloudyDarkCloudFillTemplate = (type: StyleType, color?: number[]) => {
...
/* 斜的云-模板 */
const obliqueCloudTemplate = (type: StyleType, color?: number[]) => {
  return [
    {
      ddd: 0,
      ind: 13,
...
const obliqueCloudFillTemplate = (type: StyleType, color?: number[]) => {
